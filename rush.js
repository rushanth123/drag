const brands = [
    ...
    {
      src: "img/r3.jpg",
      brandName: "jaffna rose",
      color: "#ff0000"
    },
    {
      src: "img/r4.jpg",
      brandName: "colombo rose",
      color: "#fd5c63"
    },
    {
      src: "img/r5.jpg",
  ...
  function initiateGame() {
    ...
    for(let i=0; i<randomDraggableBrands.length; i++) {
      draggableItems.insertAdjacentHTML("beforeend", `
        <img  src="${randomDraggableBrands[i].src}"  class=" draggable" draggable="true" style="color: ${randomDraggableBrands[i].color};" id="${randomDraggableBrands[i].src}">
      `);
    }
    ...
    for(let i=0; i<alphabeticallySortedRandomDroppableBrands.length; i++) {
      matchingPairs.insertAdjacentHTML("beforeend", `
        <div class="matching-pair">
          ...
          <span class="droppable" data-brand="${alphabeticallySortedRandomDroppableBrands[i].src}"></span>
        </div>
      `);
    }
  ...
  function drop(event) {
    ...
    if(isCorrectMatching) {
      ...
      event.target.innerHTML = `<img src="${draggableElementBrand}" class="draggable" style="color: ${draggableElement.style.color};"></i>`;
      correct++;  
    }
